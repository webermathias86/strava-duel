...
function LeaderboardCard({ players }) {
  ...
  return (
    <div style={{ background: "linear-gradient(135deg, #0f1117 0%, #1a1d2e 100%)", border: "1px solid #2a2d3a", borderRadius: 16, padding: 24, marginBottom: 24 }}>
          ...
          <>
            ...
            {tab === "cumulative" && (
              <div style={s.card}>
                ...
                <p style={{ color: "#666", fontSize: 12, marginBottom: 16, marginTop: -8 }}>Wer war wann vorne?</p>
